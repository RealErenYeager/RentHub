...
function tenant_register() {
    ...
    // ❌ Removed: $id_photo = $_POST['id_photo']; // This was incorrect
...
function tenant_login() {
    ...
    if ($result->num_rows == 1) {
        ...
        // ✅ Fix: prevent second session_start()
        ...
        <div class="container">
            <div class="alert">
                ...
                <strong>Incorrect Email/Password or not registered.</strong> Click here to 
                <a href="tenant-register.php" style="color: lightblue;"><b>Register</b></a>.
            </div>
        </div>
        <?php
    }
...
function tenant_update() {
    ...
    $sql = "UPDATE tenant 
            SET full_name='$full_name', email='$email', phone_no='$phone_no', address='$address', id_type='$id_type' 
